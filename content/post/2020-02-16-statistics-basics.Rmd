...
A measure of central tendency is a single value that attempts to summarize a distribution by identifying the central position within it. They represent the most common value in a distribution. In the figure below, $0$ is the most common value in a series of points ranging $-30$ to $30$.
